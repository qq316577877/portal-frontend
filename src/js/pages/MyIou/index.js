		...
		httpRequest({
			...
			success: function (response) {
					...
					$(".inform-body-top").html("<div class='top-l fl'>" +
						"							<div>" +
						"								<p class='Ious'>借据号:</p><i class='font2'>" + $obj.dbtNo + "</i></div>" +
						"							<div>" +
						"								<p class='Ious'>借据金额:</p><i class='font2'>" + $obj.offerLoan + "</i></div>" +
						"							<div>" +
						"								<p class='Ious'>还款方式:</p><i class='font2'>" + $obj.payMethod + "</i></div>" +
						"							<div>" +
						"								<p class='Ious'>借据号状态:</p><i class='font4'>" + $obj.statusDesc + "</i></div>" +
						"						</div>" +
						"						<div class='top-r fl'>" +
						"							<div>" +
						"								<p class='Ious'>强制还款日期:</p><time class='font2'>" + moment($obj.dbtExpDt).format("YYYY-MM-DD") + "</time></div>" +
						"							<div>" +
					...
					if($obj.status == 1) {
						$(".inform-body-middle").html("<h1>还款明细</h1>" +
							"						<div class='mid-l fl'>" +
							"							<div>" +
							"								<p class='Ious font5'>还款本金:</p><i class='font6'>" + $obj.offerLoan + "</i></div>" +
							"							<div>" +
							"								<p class='Ious font5 mb0'>还款日期:</p><time class='font6'>" + moment($obj.repaymentTime).format("YYYY-MM-DD") + "</time></div>" +
							"						</div>" +
							"						<div class='mid-r fl'>" +
							"							<div>" +
							"								<p class='Ious font5'>还款利息:</p><i class='font6'>" + $obj.repaymentInterest + "</i></div>" +
							"						</div>");
					};
					$(".inform-body-foot").html("<div class='ft-l fl'>" +
						...
						"							<div>" +
						"								<p class='Ious font5'>发货时间:</p><time class='font6'>" + moment($obj.deliveryTime).format("YYYY-MM-DD h:mm:ss") + "</time></div>" +
						"						</div>" +
						"						<div class='ft-r fl'>" +
						"							<div>" +
				...
				if(response.data.totalRecords < 1) {
					...
					for(var i = 0; i < listObj.length; i++) {
						...
						$(".tabBox").append("<li>" +
							...
							"<li class='font1'>" + listObj[i].appliyLoan + "</li>" +
							"<li class='font2'>" + listObj[i].statusDesc + "</li>" +
							"<li class='font1'><time>" + moment(listObj[i].dbtExpDt).format("YYYY-MM-DD") + "</time></li>" +
